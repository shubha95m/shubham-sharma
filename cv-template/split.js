window.renderSplit = (DATA, ROOT, STYLE) => {
    ...
    STYLE.innerHTML = `
        ...
        .split-theme .section { margin-bottom: 2.5rem; opacity: 0; animation: fadeIn 0.8s forwards; }
        @keyframes fadeIn { to { opacity: 1; } }
        .split-theme h2 { font-family: 'Space Grotesk', sans-serif; font-size: 1.5rem; color: #0f172a; border-bottom: 2px solid #2563eb; padding-bottom: 0.4rem; display: inline-block; margin-bottom: 1.2rem; }
        /* Removed duplicate profile-img rule to avoid conflict */
        .split-theme .timeline-item { border-left: 2px solid #cbd5e1; padding-left: 1.5rem; margin-bottom: 1.8rem; position: relative; }
        .split-theme .timeline-content h3 { margin: 0; font-size: 1.1rem; color: #020617; font-weight: 700; }
        .split-theme .company { color: #2563eb; font-weight: 600; font-family: 'Space Grotesk', sans-serif; }
        .split-theme .date { font-size: 0.9rem; color: #0f172a; margin-left: 10px; font-weight: 500; }
        ...
        .split-theme .main-content ul, .split-theme .main-content li, .split-theme .main-content p { color: #0f172a !important; }
        ...
        @media print {
            body.split-theme { display: block; height: auto; overflow: visible; }
            .split-theme .sidebar { position: relative; width: 100%; height: auto; overflow: visible; padding: 2rem; }
            .split-theme .main-content { margin-left: 0; padding: 2rem; max-width: 100%; }
        ...
        <main class="main-content">
            <section id="about" class="section">
                ...
                <div id="exec-highlights" style="margin-top: 3rem;">
                    <h3 style="color:#020617; font-family: 'Space Grotesk'; border-left: 4px solid var(--accent); padding-left: 1rem; margin-bottom: 1.5rem;">Executive Highlights</h3>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 2rem;">
                        <div>
                            <h4 style="color:var(--accent); margin-bottom: 1rem;">Scope & Impact</h4>
                            <ul class="text-dark" style="line-height: 1.6; padding-left: 1rem; font-size: 0.95rem;">
                ...
                ${DATA.journey.map(role => `
                    <div class="timeline-item">
                        ...
                        <div class="timeline-content">
                            ...
                            <ul class="text-dark" style="margin-top: 0.8rem; padding-left: 1.2rem; line-height: 1.6;">
            ...
            <section id="innovation" class="section">
                ...
                <ul class="text-dark" style="padding-left: 1.5rem; line-height: 1.8; columns: 2; column-gap: 2rem;">
